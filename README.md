...
#### _A survey to help students decide which programming track to follow, October 21, 2016_

#### By _**Chris Wingo**_

## Description

_This web application takes in the answers to five survey questions related to the various development stacks. It then performs some logic branching to determine which track to tell the student to pursue. The response to each question adds weight to various track options and the logic determines which one they gave the most weight to based on their responses. Ties are broken by an irrelevant question about a super hero. After completing the calculations the survey is hidden and the results are displayed with appropriate images_

## Setup/Installation Requirements

* _No installation required. Either clone this github repository to your desktop or download all files and folders to your desktop. Then open "index.html" to take the survey. Fill out all the questions and hit the submit button to get your results._
...
_If you find any problems with this code, want to contribute something to it, or have any questions about how or why I did certain things, please email me at cmwingo@gmail.com_

## Technologies Used

_{Powered by HTML, CSS, and Javascript. Also utilizes Bootstrap3 and JQuery 3.1.1}_
